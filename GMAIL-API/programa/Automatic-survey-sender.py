...
def enviar_email( correo:str, msj:str, asunto:str) -> bool:
    ...
    Args:
        correo (str): Correo al que se le dese enviar el mail    
        msj (str): Mensaje que ira en el cuerpo del mail
    ...
    try:
        ...
        mime_mensaje['to'] = correo
        mime_mensaje.attach(MIMEText(msj, 'html'))
...
def armar_mensaje(venta: dict) -> str:
    ...
    <img src="https://upload.wikimedia.org/wikipedia/commons/5/56/Rick_Astley.jpg" width="200" height="121"> """.format(contacto,tipo_servicio,remito, link_formulario)
    
    return mensaje


def enviar_correos(dict_ventas: dict, lista_bien_enviados: list,lista_no_enviados:list, 
lista_mal_enviados: list, lista_advertencias: list):
    ...
    for remito, venta in dict_ventas.items():
        ...
        if enviar: 
            ...
            bien_enviado = enviar_email(correo, mensaje, asunto)
...
def agregar_formularios(dict_ventas: dict, dict_forms: dict, dict_articulos: dict, lista_advertencias: list):
    ...
    for remito, venta in dict_ventas.items():
            ...
            #Al menos un articulo de mantenimiento - envia form mantenimiento
...
def main()-> None:
    ...
    if iniciar_envio(dict_ventas, dict_forms, dict_articulos):
        ...
        enviar_correos(dict_ventas, lista_bien_enviados, lista_no_enviados, lista_mal_enviados, lista_advertencias)
